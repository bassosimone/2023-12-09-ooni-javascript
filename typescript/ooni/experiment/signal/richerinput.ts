...
export class HttpsTarget {
	...
	constructor(domain: string, targetTag: string) {
		this.domain = domain
...
const defaultHttpsTargets: HttpsTarget[] = [
...
function newDefaultRicherInput(): RicherInput {
	...
	for (const entry of defaultHttpsTargets) {
